...
(defun run2 ()
  ...
  (let* ((export-file "butterfly2.png")
    ...
    (format t ", A0") 
    (draw-heatmap-from-values +height+ +width+ W-array "pics/A0-heatmap.png")
    (format t ", A1") 
    (draw-heatmap-from-values +height+ +width+ W-array "pics/A1-heatmap.png")
    (format t ", K0") 
    (draw-heatmap-from-values +height+ +width+ W-array "pics/K0-heatmap.png")
    (format t ", K1") 
    (draw-heatmap-from-values +height+ +width+ W-array "pics/K1-heatmap.png")
    (format t ", K2") 
    (draw-heatmap-from-values +height+ +width+ W-array "pics/K2-heatmap.png")
    (format t ", H0") 
    (draw-heatmap-from-values +height+ +width+ W-array "pics/H0-heatmap.png")
    (format t ", H1") 
    (draw-heatmap-from-values +height+ +width+ W-array "pics/H1-heatmap.png")
    (format t ", H2") 
    (draw-heatmap-from-values +height+ +width+ W-array "pics/H2-heatmap.png")
    (format t "~%~%")
